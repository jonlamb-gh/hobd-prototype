...
#       define Timer16_clear()  ( TCCR1B=0, TCCR1A=0, TCCR1C=0, TCNT1H=0, TCNT1L= 0, OCR1AH=0, OCR1AL=0, \
        ...
        // ----------
#       define Timer16_set_counter(value)       ( TCNT1H = ((uint8_t)(value>>8)), TCNT1L = ((uint8_t)(value)))
#       define Timer16_get_counter_low()        ((uint16_t)(TCNT1L))
#       define Timer16_get_counter_high()       ((uint16_t)(TCNT1H))
        // ----------
#       define Timer16_set_compare_a(value)     ( OCR1AH = ((uint8_t)(value>>8)), OCR1AL = ((uint8_t)(value)))
#       define Timer16_set_compare_b(value)     ( OCR1BH = ((uint8_t)(value>>8)), OCR1BL = ((uint8_t)(value)))
#       define Timer16_set_compare_c(value)     ( OCR1CH = ((uint8_t)(value>>8)), OCR1CL = ((uint8_t)(value)))
...
#       define Timer16_get_compare_c()          ( OCR1C )      // The temporary register is not used
        // ----------
#       define Timer16_set_capture(value)       { ICR1H = ((uint8_t)(value>>8)); ICR1L = ((uint8_t)(value)); }
#       define Timer16_get_capture_low()        ((uint16_t)(ICR1L))
#       define Timer16_get_capture_high()       ((uint16_t)(ICR1H))
        // ----------
...
#       define Timer16_clear()  { TCCR3B=0; TCCR3A=0; TCCR3C=0; TCNT3H=0; TCNT3L= 0; OCR3AH=0; OCR3AL=0; \
        ...
        // ----------
#       define Timer16_set_counter(value)       ( TCNT3H = ((uint8_t)(value>>8)), TCNT3L = ((uint8_t)(value)))
#       define Timer16_get_counter_low()        ((uint16_t)(TCNT3L))
#       define Timer16_get_counter_high()       ((uint16_t)(TCNT3H))
        // ----------
#       define Timer16_set_compare_a(value)     { OCR3AH = ((uint8_t)(value>>8)); OCR3AL = ((uint8_t)(value)); }
#       define Timer16_set_compare_b(value)     { OCR3BH = ((uint8_t)(value>>8)); OCR3BL = ((uint8_t)(value)); }
#       define Timer16_set_compare_c(value)     { OCR3CH = ((uint8_t)(value>>8)); OCR3CL = ((uint8_t)(value)); }
...
#       define Timer16_get_compare_c()          ( OCR3C )      // The temporary register is not used
        // ----------
#       define Timer16_set_capture(value)       { ICR3H = ((uint8_t)(value>>8)); ICR3L = ((uint8_t)(value)); }
#       define Timer16_get_capture_low()        ((uint16_t)(ICR3L))
#       define Timer16_get_capture_high()       ((uint16_t)(ICR3H))
        // ----------
...
#   elif USE_TIMER16 == BOTH_TIMER16   //!< Both the 16-bit TIMERs
    ...
    //!< =========================================
        extern uint8_t timer16_selected;         // $$$-- EXTERNAL DECLARATION --$$$ // in uart_drv.c
...
#       define Timer16_set_counter(value)   ((timer16_selected==TIMER16_1)? \
                                                (TCNT1H = ((uint8_t)(value>>8)), TCNT1L = ((uint8_t)(value)) ) \
                                                : \
                                                (TCNT3H = ((uint8_t)(value>>8)), TCNT3L = ((uint8_t)(value)) ) )
#       define Timer16_get_counter_low()    ((timer16_selected==TIMER16_1)? ((uint16_t)(TCNT1L)) : ((uint16_t)(TCNT3L)) )
#       define Timer16_get_counter_high()   ((timer16_selected==TIMER16_1)? ((uint16_t)(TCNT1H)) : ((uint16_t)(TCNT3H)) )
        // ----------
#       define Timer16_set_compare_a(value) ((timer16_selected==TIMER16_1)? \
                                                (OCR1AH = ((uint8_t)(value>>8)), OCR1AL = ((uint8_t)(value)) ) \
                                                : \
                                                (OCR3AH = ((uint8_t)(value>>8)), OCR3AL = ((uint8_t)(value)) ) )
#       define Timer16_set_compare_b(value) ((timer16_selected==TIMER16_1)? \
                                                (OCR1BH = ((uint8_t)(value>>8)), OCR1BL = ((uint8_t)(value)) ) \
                                                : \
                                                (OCR3BH = ((uint8_t)(value>>8)), OCR3BL = ((uint8_t)(value)) ) )
#       define Timer16_set_compare_c(value) ((timer16_selected==TIMER16_1)? \
                                                (OCR3CH = ((uint8_t)(value>>8)), OCR3CL = ((uint8_t)(value)) ) \
                                                : \
                                                (OCR1CH = ((uint8_t)(value>>8)), OCR1CL = ((uint8_t)(value)) ) )
...
#       define Timer16_set_capture(value)   ((timer16_selected==TIMER16_1)? \
                                                (ICR1H = ((uint8_t)(value>>8)), ICR1L = ((uint8_t)(value))) \
                                                : \
                                                (ICR3H = ((uint8_t)(value>>8)), ICR3L = ((uint8_t)(value))) )
#       define Timer16_get_capture_low()    ((timer16_selected==TIMER16_1)? ((uint16_t)(ICR1L)) : ((uint16_t)(ICR3L)) )
#       define Timer16_get_capture_high()   ((timer16_selected==TIMER16_1)? ((uint16_t)(ICR1H)) : ((uint16_t)(ICR3H)) )
        // ----------
...
//!
extern  uint16_t timer16_get_counter(void);
...
//!
extern  uint16_t timer16_get_capture(void);
