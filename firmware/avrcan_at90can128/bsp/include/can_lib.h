...
typedef enum {
  CMD_NONE,
  CMD_TX,                               // checks for rtr
  CMD_TX_DATA,                  // just sends the message
  CMD_TX_REMOTE,                // assume rtr is set
  CMD_RX,                               // receive message, doesnt touch rtr
  CMD_RX_DATA,                  // receive message, clear rtr
  CMD_RX_REMOTE,                // sets rtr to 1
  CMD_RX_MASKED,                //
  CMD_RX_DATA_MASKED,
